      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-8">
            ...
            <p className="text-sm">
              Where sustainability meets style. Join our community of conscious
              fashion lovers making a difference, one garment at a time.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="#" className="text-sm hover:text-[#E2D5C3]">
                  New Arrivals
                </a>
              </li>
              <li>
            ...
            <ul className="space-y-4">
              <li>
                <a
                  ...
                  className="text-sm hover:text-[#E2D5C3]"
                >
                  FAQs
                </a>
              </li>
